...
let state = {
  ...
  function doLogin() {
    ...
    if(!pw) { setLoginFieldErr('login-password-err','Password is required.'); return; } else { setLoginFieldErr('login-password-err',''); }
    if (pw === state.admin.password) {
      ...
      setLoginMsg('login-msg','Incorrect password.','error');
    }
  }
